      ...
      <div className = 'Skills'>
        ...
        <div className = 'SkillGrid'>
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {HTMLgo}></img>
          ...
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {CSSgo}></img>
          ...
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {JSgo}></img>
          ...
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {REACTgo}></img>
          ...
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {WPgo}></img>
          ...
          <div className = 'SkillItem'>
            <img className = 'SkillImage' src = {SHOPgo}></img>
